    ...
    <div className={SIDEBAR_CLASSES.desktop}>
      <div className="p-5 border-b border-purple-100 lg:block hidden">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-600 flex 
          items-center justify-center text-white font-bold shadow-md">
             {initial}
          </div>
          <div>
          ...
          <div className={TIP_CARD.container}>
            <div className="flex items-center gap-2">
              ...
              <div >
                ...
                <p className={TIP_CARD.text}>Use keyboard short cuts to boost Productivity!</p>
